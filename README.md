...
```
    ...
    git clone https://github.com/yourusername/genzfashion-backend.git
    cd genzfashion-backend
...
```
Node.js, Express.js, MongoDB with Mongoose, Stripe, Cloudinary, Multer
```
